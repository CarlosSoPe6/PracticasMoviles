  ...
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.POSTRES) {
      return <ProductDessert> [
        ProductDessert(
          productTitle: "Flan",
          productDescription: "Rico flan",
          productImage: "https://www.scottparatuhogar.com.do/-/media/scottparatuhogar/articles/360x312/endulza-el-dia-con-un-delicioso-flan-casero.jpg?h=312&w=360&la=es-DO&hash=2C878B27EE6498EF1299281549474115D1319BBF",
          productAmount: 0,
        ),
        ProductDessert(
          productTitle: "Flan Nopolitano",
          productDescription: "Rico flan napolitano",
          productImage: "https://cdn.kiwilimon.com/recetaimagen/2356/th5-640x640-23290.jpg",
          productAmount: 0,
        ),
        ProductDessert(
          productTitle: "Pay de limón",
          productDescription: "Pay de limón",
          productImage: "https://elgourmet.s3.amazonaws.com/recetas/cover/cuadr_ket4fzvqJ90VaEgBbKoN8GHUdjrh6u.png",
          productAmount: 0,
        ),
        ProductDessert(
          productTitle: "Pay de queso",
          productDescription: "El típico mexicano",
          productImage: "https://i2.wp.com/hornomx.com/wp-content/uploads/2020/07/mexican-cheesecake-recipe-hornomx-close.jpg?resize=730%2C487&ssl=1",
          productAmount: 0,
        ),
        ProductDessert(
          productTitle: "Pastel",
          productDescription: "Deferentes sabores",
          productImage: "https://cdn2.cocinadelirante.com/sites/default/files/styles/gallerie/public/pastelito.jpg",
          productAmount: 0,
        )
      ];
    }
